  ...
  t.describe('InstallModal', () => {
    ...
    t.it('should handle close event', () => {
      ...
      modalElement?.dispatchEvent(
        new CustomEvent('close', { detail: { shouldTerminate: true } }) as any,
      );
      t.expect(onClose).toHaveBeenCalledWith(
        new CustomEvent('close', { detail: { shouldTerminate: true } }),
      );
    });
    ...
    t.it('should handle startDesktopOnboarding event', () => {
      ...
      modalElement?.dispatchEvent(
        new CustomEvent('startDesktopOnboarding') as any,
      );
    });
  });
