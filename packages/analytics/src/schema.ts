/* eslint-disable @typescript-eslint/naming-convention -- Auto-generated API schema types */
/**
...
export type components = {
  schemas: {
    ...
    Event:
      | components['schemas']['SdkInitializedEvent']
      | components['schemas']['SdkUsedChainEvent']
      | components['schemas']['SdkConnectionInitiatedEvent']
      | components['schemas']['SdkConnectionEstablishedEvent']
      | components['schemas']['SdkConnectionRejectedEvent']
      | components['schemas']['SdkConnectionFailedEvent']
      | components['schemas']['WalletConnectionRequestReceivedEvent']
      | components['schemas']['WalletConnectionUserApprovedEvent']
      | components['schemas']['WalletConnectionUserRejectedEvent']
      | components['schemas']['SdkActionRequestedEvent']
      | components['schemas']['SdkActionSucceededEvent']
      | components['schemas']['SdkActionFailedEvent']
      | components['schemas']['SdkActionRejectedEvent']
      | components['schemas']['WalletActionReceivedEvent']
      | components['schemas']['WalletActionUserApprovedEvent']
      | components['schemas']['WalletActionUserRejectedEvent'];
    SdkInitializedEvent: {
      /**
    ...
    MMConnectPayload: {
      ...
      event_name:
        ...
        | 'mmconnect_connection_initiated'
        | 'mmconnect_connection_established'
        | 'mmconnect_connection_rejected'
        | 'mmconnect_connection_failed'
        | 'mmconnect_wallet_action_requested'
        | 'mmconnect_wallet_action_succeeded'
