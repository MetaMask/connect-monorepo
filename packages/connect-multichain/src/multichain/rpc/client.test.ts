...
t.describe('RPCClient', () => {
	...
	t.describe('invokeMethod', () => {
		t.it('should route to the wallet for eth_sendTransaction', async () => {
		...
		t.it('should route to the wallet for personal_sign', async () => {
		...
		t.it('should route to the wallet for eth_requestAccounts', async () => {
		...
		t.it('should route to the wallet for wallet_switchEthereumChain', async () => {
