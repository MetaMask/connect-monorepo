...
/* eslint-disable @typescript-eslint/no-non-null-assertion -- Tests assert known-non-null mock values */
...
t.describe('MultichainApiClientWrapperTransport', () => {
  ...
  t.describe('isTransportDefined', () => {
    ...
    t.it(
      'should return false when the underlying transport is not defined',
      () => {
  ...
  t.describe('isTransportConnected', () => {
    ...
    t.it(
      'should return false when transport exists but is not connected',
      () => {
  ...
  t.describe('connect / disconnect / isConnected', () => {
    t.it(
      'connect() should resolve without touching the underlying transport',
      async () => {
        const multichain = buildMockMultichain();
        const wrapper = buildWrapper(multichain);
    ...
    t.it(
      'disconnect() should resolve without touching the underlying transport',
      async () => {
        const multichain = buildMockMultichain();
        const wrapper = buildWrapper(multichain);
  ...
  t.describe('notification callbacks', () => {
    t.it(
      'notifyCallbacks should invoke every registered callback with the data',
      () => {
        const multichain = buildMockMultichain();
        const wrapper = buildWrapper(multichain);
    ...
    t.it(
      'onNotification should set up the transport listener and return an unsubscribe fn',
      () => {
        const multichain = buildMockMultichain();
        const wrapper = buildWrapper(multichain);
    ...
    t.it(
      'setupTransportNotificationListener should be a noop when transport is undefined',
      () => {
        const multichain = buildMockMultichain({ transport: undefined });
        const wrapper = buildWrapper(multichain);
    ...
    t.it(
      'clearTransportNotificationListener should call the disposer and clear it',
      () => {
  ...
  t.describe('wallet_createSession', () => {
    t.it(
      'should pass merged scopes/accounts/sessionProperties to multichain.connect and return wallet_getSession result',
      async () => {
        const multichain = buildMockMultichain();
  ...
  t.describe('wallet_getSession', () => {
    t.it(
      'should return an empty session when transport is not defined',
      async () => {
        const multichain = buildMockMultichain({ transport: undefined });
        const wrapper = buildWrapper(multichain);
    ...
    t.it(
      'should return an empty session when transport exists but is disconnected',
      async () => {
        const transport = buildMockTransport();
        transport.isConnected.mockReturnValue(false);
        const multichain = buildMockMultichain({ transport });
    ...
    t.it(
      'should delegate to the underlying transport when connected',
      async () => {
        const multichain = buildMockMultichain();
        const sessionResult = {
          jsonrpc: '2.0',
  ...
  t.describe('wallet_revokeSession', () => {
    t.it(
      'should call multichain.disconnect with the provided scopes and return result:true',
      async () => {
        const multichain = buildMockMultichain();
        const wrapper = buildWrapper(multichain);
    ...
    t.it(
      'should default to disconnecting all scopes when params are omitted',
      async () => {
        const multichain = buildMockMultichain();
        const wrapper = buildWrapper(multichain);
    ...
    t.it(
      'should return result:false when multichain.disconnect rejects',
      async () => {
        const multichain = buildMockMultichain();
  ...
  t.describe('wallet_invokeMethod', () => {
    t.it(
      'should return an unauthorized error when the transport is not defined',
      async () => {
        const multichain = buildMockMultichain({ transport: undefined });
        const wrapper = buildWrapper(multichain);
    ...
    t.it(
      'should return an unauthorized error when transport exists but is disconnected',
      async () => {
        const transport = buildMockTransport();
        transport.isConnected.mockReturnValue(false);
        const multichain = buildMockMultichain({ transport });
