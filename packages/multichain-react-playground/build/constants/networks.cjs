...
exports.getNetworkName = exports.FEATURED_NETWORKS = void 0;
exports.FEATURED_NETWORKS = {
...
const getNetworkName = (chainId) => {
    const entry = Object.entries(exports.FEATURED_NETWORKS).find(([_, id]) => id === chainId);
