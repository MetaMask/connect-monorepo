 ...
 */
export const injectParams = (method, exampleParams, addressToInject, scopeToInject) => {
    const { address: parsedAddress } = parseCaipAccountId(addressToInject);
    const { reference: chainId } = parseCaipChainId(scopeToInject);
    if (!(method in METHODS_REQUIRING_PARAM_INJECTION) ||
 ...
 */
export const KnownWalletRpcMethods = ['wallet_registerOnboarding', 'wallet_scanQRCode'];
/**
