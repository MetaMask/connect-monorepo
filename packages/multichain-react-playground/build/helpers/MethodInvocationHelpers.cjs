...
exports.prepareMethodRequest = exports.autoSelectAccountForScope = exports.extractRequestForStorage = exports.extractRequestParams = exports.updateInvokeMethodResults = exports.normalizeMethodParams = void 0;
/**
 ...
 */
const normalizeMethodParams = (method, params, scope) => {
...
exports.normalizeMethodParams = normalizeMethodParams;
/**
 ...
 */
const updateInvokeMethodResults = (previousResults, scope, method, result, request) => {
...
exports.updateInvokeMethodResults = updateInvokeMethodResults;
const extractRequestParams = (finalRequestObject) => {
    return finalRequestObject.params.request.params;
};
exports.extractRequestParams = extractRequestParams;
const extractRequestForStorage = (finalRequestObject) => {
    return finalRequestObject.params.request;
};
exports.extractRequestForStorage = extractRequestForStorage;
/**
 ...
 */
const autoSelectAccountForScope = (caipChainId, currentSelectedAccount, currentSession, setSelectedAccounts) => {
...
exports.autoSelectAccountForScope = autoSelectAccountForScope;
/**
 ...
 */
const prepareMethodRequest = (method, caipChainId, selectedAccount, 
// biome-ignore lint/suspicious/noExplicitAny: Needed
metamaskOpenrpcDocument, injectParams, openRPCExampleToJSON, METHODS_REQUIRING_PARAM_INJECTION) => {
    const example = metamaskOpenrpcDocument?.methods.find((methodObj) => methodObj.name === method);
    if (!example) {
...
exports.prepareMethodRequest = prepareMethodRequest;
//# sourceMappingURL=MethodInvocationHelpers.cjs.map