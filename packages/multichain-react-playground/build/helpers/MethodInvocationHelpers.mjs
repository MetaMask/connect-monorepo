 ...
 */
export const normalizeMethodParams = (method, params, scope) => {
 ...
 */
export const updateInvokeMethodResults = (previousResults, scope, method, result, request) => {
 ...
 */
export const autoSelectAccountForScope = (caipChainId, currentSelectedAccount, currentSession, setSelectedAccounts) => {
 ...
 */
export const prepareMethodRequest = (method, caipChainId, selectedAccount, 
...
//# sourceMappingURL=MethodInvocationHelpers.mjs.map